...
# LOKI2R_ind (commented out above) did not work for a list with >1000 fish IDs; must either split the fish ID list and recombine or construct the full PERB16.gcl and remove blacklisted individuals (used here)
...
write_csv(dup_check_results_pass, "dup_check_results_P066-P067_pass.csv")
```
