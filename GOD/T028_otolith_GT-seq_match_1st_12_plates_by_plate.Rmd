...
```{r}
lenth(unique(dup_check_results_DWP_14395_pass$heart_fish_id))
...
Definitely starting to think we going to have to set different cutoffs for dupe rate and dupe rate difference for each DWP. Originally suggested duplicate_rate >= 0.7 and diff >= 0.15 for 14395, and that seems to work for this plate, too. Would be nice if ggplotly worked and didn't keep throwing a "filepath too long" error.
