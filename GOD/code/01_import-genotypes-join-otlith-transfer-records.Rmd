...
```{r}
(
  heart_genotypes_GOD.gcl <- heart_genotypes.gcl %>%
...
```{r}
missing_heart_DWPs <- setdiff(affected_DWPs, unique(heart_genotypes_GOD.gcl$`48_DWP_tray_barcode`))
