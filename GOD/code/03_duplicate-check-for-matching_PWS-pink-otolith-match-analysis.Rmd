---
title: "03_duplicate-check-for-matching_PWS-pink-otolith-match-analysis"
subtitle: "Re-do with `GCLr`"
...
Figure out how many pairwise heart vs. otolith genotype comparisons we should expect and are only comparing genotypes within a DWP. This excludes the 159 "box" otoliths that were not associated with a DWP and the 1 otolith that we have zero record of.
```{r}
PGOD21.gcl %>% 
