...
Yes, there are 296 hearts that best match 2 otoliths (may be lefts and rights?) and 10 hearts that best match 10 otoliths (pieces? or bogus matches).

Need to bring in the otolith reads to see if this matters or not. If both (or all 3) matching otoliths have the same read...no big deal.
```{r}
