...
```{r}
(DWP <- GOD_DWPs[GOD_DWPs_remaining_otos_same][7])
```
...
27 GOD wells - 19 assigned = 8 unassigned GOD wells
...
33 PGOD21 - 19 assigned = 14 unassigned PGOD21 otoliths.
...
Update these 129 rows with logic matches.
```{r}
(
...
Verify all is as intended, should have 5,421 genotype matches and 129 logic matches for a total of 5,550 PGOD21 otoliths with a match assigned.
```{r}
