---
title: "Otolith_shift_DWP_visualization_P066-P067"
author: "Kyle Shedd and Kristen Gruenthal"
date: "`r Sys.Date()`"
output:
  html_notebook:
    theme: united
...
```{r}
(matchy_data <- read_csv(file = "dup_check_results_P066-P067_pass_with_wells.csv"))
```
...
Some jumped into neighboring cells, but most are just a mess.

Next: decide which designations to keep and which to toss.