---
title: "Gilmour 2017/2019 Single-generation and 2015/2017/2019 Multigenerational Parentage Analysis with 298 Markers"
...
We use the program *FRANz* [https://www.bioinf.uni-leipzig.de/Software/FRANz/About.html] to reconstruct parent-offspring relationships. Below are analyses of parentage for **Gilmour** for the **odd lineage** years **2017** (potential parents) and **2019** (potential offspring).

*FRANz* was begun on Fri Jan 15 2021 at 15:51 using the following parameters in the command line in the V:\Analysis\5_Coastwide\Multispecies\Alaska Hatchery Research Program\PWS Pink\Franz\**Gilmour_2017_2019** folder:
**FRANz --Nmmax 3000 --Nfmax 3000 --femrepro 1:2 --malerepro 1:2 --typingerror 0.006 --updatefreqs --poutformat 2 Gilmour_17_19_postQA_2017_2019_GILMOUR.dat**

The parameters are defined as follows:

* --Nmmax and --Nfmax are the maximum numbers of candidate mothers and fathers. To obtain our values, we used an estimated escapement of 6,000 and divided by 2. This escapement number came from the 2015-2017 analyses, and are listed under 'pop est walk' and 'pop est aerial' in the Excel file found here: "V:\Documents\5_Coastwide\Multispecies\AHRP\Field data\Sample Summary Extract and Genotype.xlsx". The actual aerial survey from 2017 only estimate 864 fish.  
...
parentage_17_19 <- read_csv("V:\\Analysis\\5_Coastwide\\Multispecies\\Alaska Hatchery Research Program\\PWS Pink\\Franz\\Gilmour_2017_2019\\parentage.csv") # for some reason, I keep getting and error with a relative path
paired_17_19 <- read_csv("../Franz/Gilmour_17_19_postQA_OceanAK_paired_2017_2019_GILMOUR.csv") # works for this one, tho
```
...
write_csv(paired_17_19_filter, "Gilmour_paired_17_19_filter.csv")
```
...
sample_size_plot(indata = paired_17_19_filter, title = "Gilmour 2017-2019")
```
# **Basic Statistics**
...
write_csv(parents_paired_17_19, "Gilmour_parents_paired_17_19.csv")
...
parents_paired_17_19 %>% 
  ...
  spread(origin, n)
```
**Results:** Of the **5,063** natural-origin offspring genotyped in 2019, *FRANz* assigned **249**, for an assignment rate of **4.9%**, to **602** parents (**576** natural and **26** hatchery). Most assignments (**479**) were to one parent, but there were **125** two-parent assignments. A total of **699** offspring assignments were to a natural-origin parent and **30** were to a hatchery-origin parent, with **20** from AFK15B, **4** from CCH15, **4** from SGH15, and **2** from WNH15PINKB.
...
colnames(spawners_and_offspring_17_19) <- c("Gilmour_spawners_17", "Gilmour_offspring_19")
...
write_csv(paired_17_19_filter_parents, "Gilmour_paired_17_19_filter_parents.csv")
...
colnames(rrs_17_19) <- c("Gilmour_females_17_19", "Gilmour_males_17_19")
...
write_csv(parents_paired_17_19_cross, "Gilmour_parents_paired_17_19_cross.csv")
...
colnames(rrs_Xtype_17_19) <- c("Gilmour_HNvsNN_17_19", "Gilmour_NHvsNN_17_19")
