...
# LM
(stock_h2_length_all <- as.tibble(tidy(lm(DOY.off ~ DOY.par, data = stock_triads_length))))
(stock_h2_length_NN <- as.tibble(tidy(lm(DOY.off ~ DOY.par, data = stock_triads_length %>% filter(Cross == "NN")))))
(stock_h2_length_NH <- as.tibble(tidy(lm(DOY.off ~ DOY.par, data = stock_triads_length %>% filter(Cross == "NH")))))
(stock_h2_length_HN <- as.tibble(tidy(lm(DOY.off ~ DOY.par, data = stock_triads_length %>% filter(Cross == "HN")))))
(stock_h2_length_HH <- as.tibble(tidy(lm(DOY.off ~ DOY.par, data = stock_triads_length %>% filter(Cross == "HH")))))
...
# LM
(stock_h2_date_all <- as.tibble(tidy(lm(DOY.off ~ DOY.par, data = stock_triads_date))))
(stock_h2_date_NN <- as.tibble(tidy(lm(DOY.off ~ DOY.par, data = stock_triads_date %>% filter(Cross == "NN")))))
(stock_h2_date_NH <- as.tibble(tidy(lm(DOY.off ~ DOY.par, data = stock_triads_date %>% filter(Cross == "NH")))))
(stock_h2_date_HN <- as.tibble(tidy(lm(DOY.off ~ DOY.par, data = stock_triads_date %>% filter(Cross == "HN")))))
(stock_h2_date_HH <- as.tibble(tidy(lm(DOY.off ~ DOY.par, data = stock_triads_date %>% filter(Cross == "HH")))))
...
# LM
(stock_h2_rs_all <- as.tibble(tidy(lm(DOY.off ~ DOY.par, data = stock_triads_rs))))
(stock_h2_rs_NN <- as.tibble(tidy(lm(DOY.off ~ DOY.par, data = stock_triads_rs %>% filter(Cross == "NN")))))
(stock_h2_rs_NH <- as.tibble(tidy(lm(DOY.off ~ DOY.par, data = stock_triads_rs %>% filter(Cross == "NH")))))
(stock_h2_rs_HN <- as.tibble(tidy(lm(DOY.off ~ DOY.par, data = stock_triads_rs %>% filter(Cross == "HN")))))
(stock_h2_rs_HH <- as.tibble(tidy(lm(DOY.off ~ DOY.par, data = stock_triads_rs %>% filter(Cross == "HH")))))
