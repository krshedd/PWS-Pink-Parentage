...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
# Read in data
stock_paired_14_16_filter_parents_n <- read_csv("V:/Analysis/5_Coastwide/Multispecies/Alaska Hatchery Research Program/PWS Pink/GitHub-PWS-Pink-Parentage/Stockdale/stock_paired_14_16_filter_parents.csv") %>% 
  select(franz_id, n) %>% 
  rename(n_14 = n)
stock_paired_16_18_filter_parents_n <- read_csv("V:/Analysis/5_Coastwide/Multispecies/Alaska Hatchery Research Program/PWS Pink/GitHub-PWS-Pink-Parentage/Stockdale/stock_paired_16_18_filter_parents.csv") %>% 
  select(franz_id, n) %>% 
  rename(n.off = n)

# hogan_paired_14_16_filter_parents_n <- read_csv("V:/Analysis/5_Coastwide/Multispecies/Alaska Hatchery Research Program/PWS Pink/GitHub-PWS-Pink-Parentage/Hogan/hogan_paired_14_16_filter_parents.csv") %>% 
#   select(franz_id, n) %>% 
#   rename(n_14 = n)
# hogan_paired_16_18_filter_parents_n <- read_csv("V:/Analysis/5_Coastwide/Multispecies/Alaska Hatchery Research Program/PWS Pink/GitHub-PWS-Pink-Parentage/Hogan/hogan_paired_16_18_filter_parents.csv") %>% 
#   select(franz_id, n) %>% 
#   rename(n.off = n)

gilmour_paired_14_16_filter_parents_n <- read_csv("V:/Analysis/5_Coastwide/Multispecies/Alaska Hatchery Research Program/PWS Pink/GitHub-PWS-Pink-Parentage/Gilmour/gilmour_paired_14_16_filter_parents.csv") %>% 
  select(franz_id, n) %>% 
  rename(n_14 = n)
gilmour_paired_16_18_filter_parents_n <- read_csv("V:/Analysis/5_Coastwide/Multispecies/Alaska Hatchery Research Program/PWS Pink/GitHub-PWS-Pink-Parentage/Gilmour/gilmour_paired_16_18_filter_parents.csv") %>% 
  select(franz_id, n) %>% 
  rename(n.off = n)

# paddy_paired_14_16_filter_parents_n <- read_csv("V:/Analysis/5_Coastwide/Multispecies/Alaska Hatchery Research Program/PWS Pink/GitHub-PWS-Pink-Parentage/Paddy/paddy_paired_14_16_filter_parents.csv") %>% 
#   select(franz_id, n) %>% 
#   rename(n_14 = n)
# paddy_paired_16_18_filter_parents_n <- read_csv("V:/Analysis/5_Coastwide/Multispecies/Alaska Hatchery Research Program/PWS Pink/GitHub-PWS-Pink-Parentage/Paddy/paddy_paired_16_18_filter_parents.csv") %>% 
#   select(franz_id, n) %>% 
#   rename(n.off = n)
# 
# erb_paired_14_16_filter_parents_n <- read_csv("V:/Analysis/5_Coastwide/Multispecies/Alaska Hatchery Research Program/PWS Pink/GitHub-PWS-Pink-Parentage/Erb/erb_paired_14_16_filter_parents.csv") %>% 
#   select(franz_id, n) %>% 
#   rename(n_14 = n)
# erb_paired_16_18_filter_parents_n <- read_csv("V:/Analysis/5_Coastwide/Multispecies/Alaska Hatchery Research Program/PWS Pink/GitHub-PWS-Pink-Parentage/Erb/erb_paired_16_18_filter_parents.csv") %>% 
#   select(franz_id, n) %>% 
#   rename(n.off = n)
...
1. Stockdale -- nada
2. Hogan -- TBD
3. Gilmour -- also nada - wonder if we should consider looking at this by dyad...how to do that?...
4. Paddy -- TBD
5. Erb -- TBD
