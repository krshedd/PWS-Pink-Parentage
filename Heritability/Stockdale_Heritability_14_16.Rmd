...
stock_parents_paired_14_16_length1_HH <- as.data.frame(c(stock_parents_paired_14_16_length1[4,2], stock_parents_paired_14_16_length1[4,3]*2))
stock_parents_paired_14_16_length1_HN <- as.data.frame(c(stock_parents_paired_14_16_length1[3,2], stock_parents_paired_14_16_length1[3,3]*2))
...
stock_parents_paired_14_16_length1_NN <- as.data.frame(c(stock_parents_paired_14_16_length1[1,2], stock_parents_paired_14_16_length1[1,3]*2))
...
stock_r_and_h2_length_14_16 <- rbind(stock_parents_paired_14_16_length1_HH, stock_parents_paired_14_16_length1_HN, stock_parents_paired_14_16_length1_HN, stock_parents_paired_14_16_length1_NN, stock_parents_paired_14_16_length2_dF, stock_parents_paired_14_16_length2_dM, stock_parents_paired_14_16_length3_sF, stock_parents_paired_14_16_length3_sM) %>% round(3)
...
stock_parents_paired_14_16_date1_HH <- as.data.frame(c(stock_parents_paired_14_16_date1[4,2], stock_parents_paired_14_16_date1[4,3]*2))
stock_parents_paired_14_16_date1_HN <- as.data.frame(c(stock_parents_paired_14_16_date1[3,2], stock_parents_paired_14_16_date1[3,3]*2))
...
stock_parents_paired_14_16_date1_NN <- as.data.frame(c(stock_parents_paired_14_16_date1[1,2], stock_parents_paired_14_16_date1[1,3]*2))
...
stock_r_and_h2_date_14_16 <- rbind(stock_parents_paired_14_16_date1_HH, stock_parents_paired_14_16_date1_HN, stock_parents_paired_14_16_date1_HN, stock_parents_paired_14_16_date1_NN, stock_parents_paired_14_16_date2_dF, stock_parents_paired_14_16_date2_dM, stock_parents_paired_14_16_date3_sF, stock_parents_paired_14_16_date3_sM) %>% round(3)
...
stock_parents_paired_14_16_rs1_HH <- as.data.frame(c(stock_parents_paired_14_16_rs1[4,2], stock_parents_paired_14_16_rs1[4,3]*2))
stock_parents_paired_14_16_rs1_HN <- as.data.frame(c(stock_parents_paired_14_16_rs1[3,2], stock_parents_paired_14_16_rs1[3,3]*2))
...
stock_parents_paired_14_16_rs1_NN <- as.data.frame(c(stock_parents_paired_14_16_rs1[1,2], stock_parents_paired_14_16_rs1[1,3]*2))
...
stock_r_and_h2_rs_14_16 <- rbind(stock_parents_paired_14_16_rs1_HH, stock_parents_paired_14_16_rs1_HN, stock_parents_paired_14_16_rs1_HN, stock_parents_paired_14_16_rs1_NN, stock_parents_paired_14_16_rs2_dF, stock_parents_paired_14_16_rs2_dM, stock_parents_paired_14_16_rs3_sF, stock_parents_paired_14_16_rs3_sM) %>% round(3)
...
stock_h2_rs_14_16 <- merge(stock_r_and_h2_rs_14_16, stock_slope_as_h2_rs_14_16,  by="Category") %>% 
    ...
    rename(Stockdale_14_16 = Category, "h^2.correlation" = "Heritability (h^2).x", "h^2.slope" = "Heritability (h^2).y", "h^2.variance" = "Heritability (h^2)")
(stock_h2_rs_14_16 <- stock_h2_rs_14_16[c(6,5,4,3,1,2,7,8),])
```
