...
# make df
stock_slope_as_h2_length_14_16 <- as.data.frame(rbind(stock_h2_length_14_16_all_tbl[2,2], 
                                                      stock_h2_length_14_16_NN_tbl[2,2], 
                                                      stock_h2_length_14_16_NH_tbl[2,2], 
                                                      stock_h2_length_14_16_HN_tbl[2,2], 
                                                      stock_h2_length_14_16_HH_tbl[2,2], 
                                                      stock_h2_length_14_16_dam_tbl[2,2], 
                                                      stock_h2_length_14_16_sire_tbl[2,2], 
                                                      stock_h2_length_14_16_dF_tbl[2,2], 
                                                      stock_h2_length_14_16_dM_tbl[2,2], 
                                                      stock_h2_length_14_16_sF_tbl[2,2], 
                                                      stock_h2_length_14_16_sM_tbl[2,2]) %>% 
                                                  round(3))
...
# lme4
# overall
stock_h2_lmer_length_14_16_dam_sire <- lmer(Length.off ~ (1|Length.sire)+(1|Length.dam), data = stock_triads_length_14_16, na.action = na.omit)
(summary(stock_h2_lmer_length_14_16_dam_sire))
...
# all offspring
stock_h2_length_14_16_dAll <- (16.347) / (1.903 + 16.347 + 485.707)
stock_h2_length_14_16_sAll <- (1.903) / (1.903 + 16.347 + 485.707)
...
# make df
stock_slope_as_h2_date_14_16 <- as.data.frame(rbind(stock_h2_date_14_16_all_tbl[2,2], 
                                                      stock_h2_date_14_16_NN_tbl[2,2], 
                                                      stock_h2_date_14_16_NH_tbl[2,2], 
                                                      stock_h2_date_14_16_HN_tbl[2,2], 
                                                      stock_h2_date_14_16_HH_tbl[2,2], 
                                                      stock_h2_date_14_16_dam_tbl[2,2], 
                                                      stock_h2_date_14_16_sire_tbl[2,2], 
                                                      stock_h2_date_14_16_dF_tbl[2,2], 
                                                      stock_h2_date_14_16_dM_tbl[2,2], 
                                                      stock_h2_date_14_16_sF_tbl[2,2], 
                                                      stock_h2_date_14_16_sM_tbl[2,2]) %>% 
                                                  round(3))
...
# all offspring
stock_h2_date_14_16_dAll <- (7.114) / (1.068 + 7.114 + 48.328)
stock_h2_date_14_16_sAll <- (1.068) / (1.068 + 7.114 + 48.328)
...
## Sample Location: Stream location/distance DNE for most samples
...
# make df
stock_slope_as_h2_rs_14_16 <- as.data.frame(rbind(stock_h2_rs_14_16_all_tbl[2,2], 
                                                      stock_h2_rs_14_16_NN_tbl[2,2], 
                                                      stock_h2_rs_14_16_NH_tbl[2,2], 
                                                      stock_h2_rs_14_16_HN_tbl[2,2], 
                                                      stock_h2_rs_14_16_HH_tbl[2,2], 
                                                      stock_h2_rs_14_16_dam_tbl[2,2], 
                                                      stock_h2_rs_14_16_sire_tbl[2,2], 
                                                      stock_h2_rs_14_16_dF_tbl[2,2], 
                                                      stock_h2_rs_14_16_dM_tbl[2,2], 
                                                      stock_h2_rs_14_16_sF_tbl[2,2], 
                                                      stock_h2_rs_14_16_sM_tbl[2,2]) %>% 
                                                  round(3))
...
```{r}
# lme4::lmer
# BUT RS has a zero-inflated negative binomial distribution; lmer not really appropriate for model fitting
# HOWEVER does it really matter if everything comes up h^2 = 0?
# overall
...
stock_h2_rs_14_16_HH <- 0.00

# all offspring
stock_h2_rs_14_16_dAll <- 0.00 / (0.00 + 0.00 + 0.1275)
stock_h2_rs_14_16_sAll <- 0.00 / (0.00 + 0.00 + 0.1275)
...
# lmer::glmer
# overall
stock_h2_rs_14_16_dam_sire_glmer <- glmer.nb(n.off ~ (1|n.sire)+(1|n.dam), data = stock_triads_rs_14_16, na.action = na.omit)
(summary(stock_h2_rs_14_16_dam_sire_glmer))
# stock_h2_rs_14_16_all_glmer <- 0.00 / (0.00 + 0.00)
plot(stock_h2_rs_14_16_dam_sire_glmer)
hist(resid(stock_h2_rs_14_16_dam_sire_glmer))

# by cross
stock_h2_rs_14_16_NN_glmer <- stock_triads_rs_14_16 %>% filter(Cross == "NN")
stock_h2_rs_14_16_dam_sire_NN_glmer <- glmer.nb(n.off ~ (1|n.sire)+(1|n.dam), data = stock_h2_rs_14_16_NN, na.action = na.omit)
(summary(stock_h2_rs_14_16_dam_sire_NN_glmer))
# stock_h2_rs_14_16_NN_glmer <- 0.00 / (0.00 + 0.000000000001826)

stock_h2_rs_14_16_NH_glmer <- stock_triads_rs_14_16 %>% filter(Cross == "NH")
stock_h2_rs_14_16_dam_sire_NH_glmer <- glmer.nb(n.off ~ (1|n.sire)+(1|n.dam), data = stock_h2_rs_14_16_NH, na.action = na.omit)
(summary(stock_h2_rs_14_16_dam_sire_NH_glmer))
# stock_h2_rs_14_16_NH_glmer <- 0.00 / (0.00 + 0.00 + 0.07123)

stock_h2_rs_14_16_HN_glmer <- stock_triads_rs_14_16 %>% filter(Cross == "HN")
stock_h2_rs_14_16_dam_sire_HN_glmer <- glmer.nb(n.off ~ (1|n.sire)+(1|n.dam), data = stock_h2_rs_14_16_HN, na.action = na.omit)
(summary(stock_h2_rs_14_16_dam_sire_HN_glmer))
# stock_h2_rs_14_16_HN_glmer <- 0.00 / (0.00 + 0.00 + 0.06237)

stock_h2_rs_14_16_HH_glmer <- stock_triads_rs_14_16 %>% filter(Cross == "HH")
stock_h2_rs_14_16_dam_sire_HH_glmer <- glmer(n.off ~ (1|n.sire)+(1|n.dam), data = stock_h2_rs_14_16_HH, na.action = na.omit)
(summary(stock_h2_rs_14_16_dam_sire_HH_glmer))
# stock_h2_rs_14_16_HH_glmer <- 0.00 / (0.00 + 0.00 + 0.06237)

# all offspring
# stock_h2_rs_14_16_dAll_glmer <- 0.00 / (0.00 + 0.00 + 0.1275)
# stock_h2_rs_14_16_sAll_glmer <- 0.00 / (0.00 + 0.00 + 0.1275)

# by sex
stock_h2_rs_14_16_F_glmer <- stock_triads_rs_14_16 %>% filter(Sex.off == "F")
stock_h2_rs_14_16_dam_sire_F_glmer <- glmer.nb(n.off ~ (1|n.sire)+(1|n.dam), data = stock_h2_rs_14_16_F, na.action = na.omit)
(summary(stock_h2_rs_14_16_dam_sire_F_glmer))
# stock_h2_rs_14_16_dam_F_glmer <- 0.00 / (0.00 + 0.00 + 0.1211)
# stock_h2_rs_14_16_sire_F_glmer <- 0.00 / (0.00 + 0.00 + 0.1211)

stock_h2_rs_14_16_M_glmer <- stock_triads_rs_14_16 %>% filter(Sex.off == "M")
stock_h2_rs_14_16_dam_sire_M_glmer <- glmer.nb(n.off ~ (1|n.sire)+(1|n.dam), data = stock_h2_rs_14_16_M, na.action = na.omit)
(summary(stock_h2_rs_14_16_dam_sire_M_glmer))
# stock_h2_rs_14_16_dam_M_glmer <- 0.00 / (0.00 + 0.00 + 0.1363)
# stock_h2_rs_14_16_sire_M_glmer <- 0.00 / (0.00 + 0.00 + 0.1363)

# make dfs
# stock_am_for_h2_rs_14_16_glmer <- as.data.frame(c(stock_h2_rs_14_16_all_glmer, 
#                                               stock_h2_rs_14_16_NN_glmer, 
#                                               stock_h2_rs_14_16_NH_glmer, 
#                                               stock_h2_rs_14_16_HN_glmer, 
#                                               stock_h2_rs_14_16_HH_glmer, 
#                                               stock_h2_rs_14_16_dAll_glmer,
#                                               stock_h2_rs_14_16_sAll_glmer,
#                                               stock_h2_rs_14_16_dam_F_glmer, 
#                                               stock_h2_rs_14_16_dam_M_glmer, 
#                                               stock_h2_rs_14_16_sire_F_glmer, 
#                                               stock_h2_rs_14_16_sire_M_glmer)) %>% 
#                                             round(3)
# 
# colnames(stock_am_for_h2_rs_14_16_glmer) <- c("Heritability (h^2)")
# stock_am_for_h2_rs_14_16_glmer$Category <- c("Overall", "NN", "NH", "HN", "HH", "Dam/All offspring", "Sire/All offspring", "Dam/Female offspring", "Dam/Male offspring", "Sire/Female offspring", "Sire/Male offspring")
# 
# (stock_am_for_h2_rs_14_16_glmer <- stock_am_for_h2_rs_14_16_glmer[,c(2,1)])
```
