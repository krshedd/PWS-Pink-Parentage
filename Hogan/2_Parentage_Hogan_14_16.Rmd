...
write_csv(parents_paired_14_16, "hogan_parents_paired_14_16.csv")
...
O.even <- c("H", "N")
Spawners.even <- c(437, 214) #  number of hatchery- and natural-origin parents
Offspring.even <- c(265, 208)  # number of offspring assigned to hatchery- and natural-origin parents
...
Female parents produced 1-10 offspring, while male parents produced 1-13.  
...
write_csv(paired_14_16_filter_parents, "hogan_paired_14_16_filter_parents.csv")
...
We have 22 individuals who were assigned to 2 parents, but I don't have time to look at this now.

```{r}
parents_paired_14_16_cross <- read_csv(file = "parents_paired_14_16_cross.csv")
```
