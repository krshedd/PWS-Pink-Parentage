...
**Note** that *FRANz* assigned 262 offspring to 202 parents. 221 of these offsrping have natural-origin parents and 41 offspring have hatchery-origin parents. The hatchery origin fish are from AFK13B, CCH13, and WNH13PINKB.
...
# HH vs. NN
rrs_ci_kalinowski(n_h_off = 2, n_w_off = 51, n_h_par = 2, n_w_par = 40, alpha = 0.05) # Significant!
...
2. 262 offspring were assigned to 202 parents, for an assignment rate of **6.5%**.  
