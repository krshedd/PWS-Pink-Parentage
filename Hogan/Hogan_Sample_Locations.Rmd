...
ggpairs(reduced, mapping = aes(color = Origin, alpha = 0.5), columns = c( "Sample Date", "Length Mm",  "Distance","RS","Sex"), columnLabels = c("Sample Date", "Length (mm)", "Distance (m)", "RS","Sex"), 
        progress = FALSE, 
