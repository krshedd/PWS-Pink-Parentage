...
# Introduction
This is a summary of parentage analysis and relative reproductive success (RRS) results from Hogan Bay 2013-2016 for the Science Panel. These results will be used to inform additional analyses  (e.g. investigating the impact of spawning location on reproductive success). We intend to present these results at both the March 7th AHRP Informational Meeting and at the Alaska Chapter of the American Fisheries Society meeting in Sitka March 19-22. These analyses were funded by the North Pacific Research Board. 
...
We calculate RRS as Hatchery RS divided by Natural RS. 
...
We examined associations between two potential explanatory variables (sample date and body size) and RS. These plots include loess smoothing with 95% confidence intervals. We use loess rather than linear models because our data violate assumptions of normality. 
...
The above plot show RS by parent body length, separately for females (top) and males (bottom). It is difficult to draw conclusions about this relationship for hatchery-origin parents since there were so few assignments. Larger females may have higher RS than smaller females and there doesn't appear to be a strong relationship between RS and length for males. Again, sample sizes are small, which makes it difficult to draw robust conclusions.
...
2. 48 offspring were assigned to 20 parents (3 of which were hatchery-origin), for an assignment rate of **2.5%**. This is in line with our expectation given the depth of parental sampling.  
3. Female RRS was 0.02 (0.01-0.09). Male RRS was 0.12 (0.02-0.40). Both male and female hatchery-origin fish produced significantly fewer offspring than natural-origin fish.  
4. Family size varied from 0-16 for females and 0-4 for males.  
5. It is difficult to draw clear conclusions about relationships between RS and either sample date or parental size due to the low offspring assignment rate.   
...
From this histogram, we can see that in the parent generation (2014), natural-origin fish tended to have earlier sampling dates than hatchery-origin fish, which confirms what we know about differences in run timing. We can also see how sparse the field sampling was in 2014 compared to 2016. Offspring in 2016 were sampled throughout the run.
...
Of the 4,020 offspring collected in 2016, 451 were assigned to at least 1 parent, for an an overall offspring assignment rate of **11%**. This is in line with expectations based on parent sampling depth
...
The above table shows the *p-values* for each test and sex, which are all below 0.001. Female hatchery-origin fish produced significantly fewer offspring on average than their natural-origin counterparts, but there was no significant difference in RS for males.  
...
### Plots of RS vs. field data
As in the odd-lineage above, we examined associations between two potential explanatory variables (sample date and body size) and RS. Since we have many more offspring assignments, we can more clearly visualize these relationships. These plots include loess smoothing with 95% confidence intervals. We use loess rather than linear models because our data violate assumptions of normality.
...
The above plot shows RS by parent sample date, separately for females (top) and males (bottom). We see that RS does vary due to sample date, with the lowest RS values in the middle of the season (perhaps due to increased fishing pressure or density dependence on the spawning grounds). Most of the productivity at the end of the season is driven by hatchery-origin fish. 
...
1. Exclusion probabilities were equal to 1.00, which means we can be confident in the ability of our marker set to correctly assign parents to offspring.  
2. 451 offspring were assigned to 184 parents, for an assignment rate of **11%**. This is in line with our expectations based on parental depth of sampling. 208 assignments were to natural origin parents and 265 were to hatchery origin parents. *FRANz* was able to make both 1- and 2-parent assignments.
3. Family size varied from 0-10 for females and 0-13 for males.  
4. Natural origin females had significantly higher RS than hatchery origin females, but there was not a significant difference for males. Female RRS was 0.47(0.37-0.62) and male RRS was 0.87(0.67-1.12).   
