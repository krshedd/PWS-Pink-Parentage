...
Here are our sample sizes for potential parents (2013) and potential offspring (2015) by sex and origin.
...
All parentage assigments have a posterior probability of 1.00, which means that no offspring assignments were split among multiple potential parents. (All assignments were unequivocal). 
...
### Calculate mean RS
We calculated the mean RS by origin and sex including sampled fish from the parental generation to which offspring were not assigned.**Note** this analysis was not presented at the December meeting. In the table below (and across all analyses), we round to 2 decimal places. Female hatchery RS below is therefore 0.00, but there was actually one offspring assigned to a hatchery-origin female. 
...
We calculate RRS as mean Hatchery RS divided by mean Natural RS. **Note** this analysis was not presented at the December meeting. 
...
Hogan 2013/2015 **female** RRS with 95% CI = **`r paste0(formatC(odd_female_rrs_CI[2], format = "f", digits = 2), " (", formatC(odd_female_rrs_CI[1], format = "f", digits = 2), "-", formatC(odd_female_rrs_CI[3], format = "f", digits = 2), ")")`**

Hogan 2013/2015 **male** RRS with 95% CI = **`r paste0(formatC(odd_male_rrs_CI[2], format = "f", digits = 2), " (", formatC(odd_male_rrs_CI[1], format = "f", digits = 2), "-", formatC(odd_male_rrs_CI[3], format = "f", digits = 2), ")")`**
...
The above plot show RS by parent body length, separately for females (top) and males (bottom). It is difficult to draw conclusions about this relationship for hatchery-origin parents since there were so few assignments.
...
**Note** that *FRANz* assigned 451 offspring to 184 parents in single parent assignments (*single parent-offspring duos*). 208 of these assignments are to natural origin parents and 265 assignments were to hatchery origin parents. Hatchery origin parents are from AFK, CCH, and WNH; none are from Solomon Gulch (VFDA).  
...
## Reproductive success
Here, we calculate and plot reproductive success (RS; number of offspring assigned to parents) for both natural and hatchery parents. The number of offspring assigned ranges from 0-13 for males and 0-10 for females. 
...
Hogan 2014/2016 **female** RRS with 95% CI = **`r paste0(formatC(even_female_rrs_CI[2], format = "f", digits = 2), " (", formatC(even_female_rrs_CI[1], format = "f", digits = 2), "-", formatC(even_female_rrs_CI[3], format = "f", digits = 2), ")")`**

Hogan 2014/2016 **male** RRS with 95% CI = **`r paste0(formatC(even_male_rrs_CI[2], format = "f", digits = 2), " (", formatC(even_male_rrs_CI[1], format = "f", digits = 2), "-", formatC(even_male_rrs_CI[3], format = "f", digits = 2), ")")`**
...
The above plot shows RS by parent sample date, separately for females (top) and males (bottom). We see that RS does vary due to sample date, with the lowest RS values in the middle of the season (perhaps due to density dependence on the spawning grounds). There do appear to be some differences in RS between natural- and hatchery-origin fish early in the season for females and later in the season for males.
...
The above plot show RS by parent body length, separately for females (top) and males (bottom). No clear pattern is apparent for either sex.  
...
Hogan 2014/2016 **HH/NN** RRS with 95% CI = **`r paste0(formatC(even_HH_NN_rrs_CI[2], format = "f", digits = 2), " (", formatC(even_HH_NN_rrs_CI[1], format = "f", digits = 2), "-", formatC(even_HH_NN_rrs_CI[3], format = "f", digits = 2), ")")`**

Hogan 2014/2016 **HN/NN** RRS with 95% CI = **`r paste0(formatC(even_HN_NN_rrs_CI[2], format = "f", digits = 2), " (", formatC(even_HN_NN_rrs_CI[1], format = "f", digits = 2), "-", formatC(even_HN_NN_rrs_CI[3], format = "f", digits = 2), ")")`**

Hogan 2014/2016 **NH/NN** RRS with 95% CI = **`r paste0(formatC(even_NH_NN_rrs_CI[2], format = "f", digits = 2), " (", formatC(even_NH_NN_rrs_CI[1], format = "f", digits = 2), "-", formatC(even_NH_NN_rrs_CI[3], format = "f", digits = 2), ")")`**
