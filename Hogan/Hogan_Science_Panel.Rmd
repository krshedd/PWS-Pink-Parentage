...
4. It is difficult to draw clear conclusions about relationships between RS and either sample date or parental size due to the low offspring assignment rate.   
...
1. Exclusion probabilities were equal to 1.00, which means we can be confident in the ability of our marker set to correctly assign parents to offspring.  
2. 1,059 offspring were assigned to 405 parents, for an assignment rate of **20.3%**. This is in line with our expectations based on depth of parental sampling.  
...
6. RS varied with parent sample date (early fish do best, middle fish worst, late returning okay).
7. RS varied with parent size (larger fish had more offspring than smaller fish).
8. Family size varied from 0-10 for females and 0-13 for males.  
