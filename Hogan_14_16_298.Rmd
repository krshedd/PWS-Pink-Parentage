...
paired_14_16 <- read_csv("../Franz/2014_2016_Hogan_Run1_298/hogan_postQA_OceanAK_paired_2014_2016_HOGAN.csv")
```
...
```{r Re-calculate RRS}
parents_paired_13_15 <- read_csv("304/parents_paired_13_15.csv") %>% 
...
M_0_CI <- oneway_test(n ~ origin, data = mydata_M_0, distribution = approximate(B = 10000), conf.int = 0.9)
...
Calculate 95% CIs for Hogan 14-16 females. Female RRS = 0.47 (0.37-0.62).

```{r RRS_confidence_intervals_female}
# Females
...
Calculate 95% CIs for Hogan 14-16 males. Male RRS = 0.87 (0.67-1.12).

```{r RRS_confidence_intervals_male}
# Males
# Get parent sample sizes
paired_14_16_filter_parents %>% 
  filter(SEX == "M") %>% 
...
```
265 offspring matched up to hatchery-origin parents, while 208 offspring assgined to natural-origin parents. 
...
write_csv(parents_paired_14_16_cross, "parents_paired_14_16_cross.csv")
...
write_csv(paired_14_16_filter, "paired_14_16_filter.csv")
...
2. 451 offspring were assigned to 184 parents, for an assignment rate of **11%**. 208 assignments were to natural origin parents and 265 were to hatchery origin parents. *FRANz* was able to make both 1- and 2-parent assignments.
