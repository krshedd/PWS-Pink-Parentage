...
paired_13_15_filter %>% 
  ...
  labs(title="Number of Samples per Year by Date and Origin",
       fill = "Origin")
ggsave("samples_odd.png", path = "V:/Documents/5_Coastwide/Multispecies/AHRP/Manuscripts/01.Hogan/0002.Figures&Tables/Figure 2/")
```
...
paired_14_16_filter %>% 
  ...
  labs(title="Number of Samples per Year by Date and Origin",
       fill = "Origin")
ggsave("samples_even.png", path = "V:/Documents/5_Coastwide/Multispecies/AHRP/Manuscripts/01.Hogan/0002.Figures&Tables/Figure 2/")
```
...
paired_13_15_filter_parents %>% 
  ...
  labs(title="Reproductive Success for Odd-Lineage",
       fill = "Parent: Origin") +
  facet_grid(. ~ sex)
  ggsave("RS_Odd_Facet.png", path = "V:/Documents/5_Coastwide/Multispecies/AHRP/Manuscripts/01.Hogan/0002.Figures&Tables/Figure 3/")
```
...
paired_14_16_filter_parents %>% 
  ...
  xlab("Number of Offspring") +
  ylab("Proportion of Parents") +
  labs(title="Reproductive Success for Even-Lineage",
       fill = "Parent: Origin") +
  facet_grid(. ~ sex)
  ggsave("RS_Even_Facet.png", path = "V:/Documents/5_Coastwide/Multispecies/AHRP/Manuscripts/01.Hogan/0002.Figures&Tables/Figure 3/")
```
