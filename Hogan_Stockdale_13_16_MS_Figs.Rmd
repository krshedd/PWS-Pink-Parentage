...
```{r}
t.test(`Length Mm` ~ origin, data = filter(`Silly Code` == "PHOGAN13" & sex == "M", .data = ANOVA))$p.value < 0.05
t.test(`Length Mm` ~ origin, data = filter(`Silly Code` == "PHOGAN14" & sex == "M", .data = ANOVA))$p.value < 0.05
t.test(`Length Mm` ~ origin, data = filter(`Silly Code` == "PHOGAN13" & sex == "F", .data = ANOVA))$p.value < 0.05
t.test(`Length Mm` ~ origin, data = filter(`Silly Code` == "PHOGAN14" & sex == "F", .data = ANOVA))$p.value < 0.05
t.test(`Length Mm` ~ origin, data = filter(`Silly Code` == "PSTOCK13" & sex == "M", .data = ANOVA))$p.value < 0.05
t.test(`Length Mm` ~ origin, data = filter(`Silly Code` == "PSTOCK14" & sex == "M", .data = ANOVA))$p.value < 0.05
t.test(`Length Mm` ~ origin, data = filter(`Silly Code` == "PSTOCK13" & sex == "F", .data = ANOVA))$p.value < 0.05
t.test(`Length Mm` ~ origin, data = filter(`Silly Code` == "PSTOCK14" & sex == "F", .data = ANOVA))$p.value < 0.05
```
...
```{r}
wilcox.test(DOY ~ origin, data = filter(`Silly Code` == "PHOGAN13" & sex == "M", .data = ANOVA))$p.value < 0.05
wilcox.test(DOY ~ origin, data = filter(`Silly Code` == "PHOGAN14" & sex == "M", .data = ANOVA))$p.value < 0.05
wilcox.test(DOY ~ origin, data = filter(`Silly Code` == "PHOGAN13" & sex == "F", .data = ANOVA))$p.value < 0.05
wilcox.test(DOY ~ origin, data = filter(`Silly Code` == "PHOGAN14" & sex == "F", .data = ANOVA))$p.value < 0.05
wilcox.test(DOY ~ origin, data = filter(`Silly Code` == "PSTOCK13" & sex == "M", .data = ANOVA))$p.value < 0.05
wilcox.test(DOY ~ origin, data = filter(`Silly Code` == "PSTOCK14" & sex == "M", .data = ANOVA))$p.value < 0.05
wilcox.test(DOY ~ origin, data = filter(`Silly Code` == "PSTOCK13" & sex == "F", .data = ANOVA))$p.value < 0.05
wilcox.test(DOY ~ origin, data = filter(`Silly Code` == "PSTOCK14" & sex == "F", .data = ANOVA))$p.value < 0.05
```
...
```{r}
wilcox.test(Distance ~ origin, data = filter(`Silly Code` == "PHOGAN13" & sex == "M", .data = ANOVA))$p.value < 0.05
wilcox.test(Distance ~ origin, data = filter(`Silly Code` == "PHOGAN14" & sex == "M", .data = ANOVA))$p.value < 0.05
wilcox.test(Distance ~ origin, data = filter(`Silly Code` == "PHOGAN13" & sex == "F", .data = ANOVA))$p.value < 0.05
wilcox.test(Distance ~ origin, data = filter(`Silly Code` == "PHOGAN14" & sex == "F", .data = ANOVA))$p.value < 0.05
wilcox.test(Distance ~ origin, data = filter(`Silly Code` == "PSTOCK13" & sex == "M", .data = ANOVA))$p.value < 0.05
wilcox.test(Distance ~ origin, data = filter(`Silly Code` == "PSTOCK14" & sex == "M", .data = ANOVA))$p.value < 0.05
wilcox.test(Distance ~ origin, data = filter(`Silly Code` == "PSTOCK13" & sex == "F", .data = ANOVA))$p.value < 0.05
wilcox.test(Distance ~ origin, data = filter(`Silly Code` == "PSTOCK14" & sex == "F", .data = ANOVA))$p.value < 0.05
```
