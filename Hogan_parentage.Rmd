...
paired_14_16_filter_parents %>% 
  ...
  labs(title="Number of Offspring for Females",
       fill = "Parent: Origin") +
  geom_vline(xintercept=F_n_0, size=2) +
  geom_vline(xintercept=F_n_0, color=gg_color_hue(2)[1], linetype = "dashed", size=2) +
  geom_vline(xintercept=F_h_0, size=2) +
  geom_vline(xintercept=F_h_0, color=gg_color_hue(2)[2], linetype = "dashed", size=2) +
  annotate("text", x = F_n_0 + 0.5, y = 250, label = paste("F_n_0 =", round(F_n_0, 2)), hjust = 0, size = 6, color = gg_color_hue(2)[1]) +
  annotate("text", x = F_h_0 + 0.5, y = 300, label = paste("F_h_0 =", round(F_h_0, 2)), hjust = 0, size = 6, color = gg_color_hue(2)[2])
...
paired_14_16_filter_parents %>% 
  ...
  labs(title="Number of Offspring for Males",
       fill = "Parent: Origin") +
  geom_vline(xintercept=M_n_0, size=2) +
  geom_vline(xintercept=M_n_0, color=gg_color_hue(2)[1], linetype = "dashed", size=2) +
  geom_vline(xintercept=M_h_0, size=2) +
  geom_vline(xintercept=M_h_0, color=gg_color_hue(2)[2], linetype = "dashed", size=2) +
  annotate("text", x = M_n_0 + 0.5, y = 150, label = paste("M_n_0 =", round(M_n_0, 2)), hjust = 0, size = 6, color = gg_color_hue(2)[1]) +
  annotate("text", x = F_h_0 + 0.5, y = 100, label = paste("M_h_0 =", round(M_h_0, 2)), hjust = 0, size = 6, color = gg_color_hue(2)[2])
...
paired_14_16_filter_parents %>% 
  ...
  geom_vline(xintercept=M_h_0, size=2) +
  geom_vline(xintercept=M_h_0, color=gg_color_hue(2)[2], linetype = "dashed", size=2) +
  annotate("text", x = M_n_0 + 0.5, y = .250, label = paste("M_n_0 =", round(M_n_0, 2)), hjust = 0, size = 6, color = gg_color_hue(2)[1]) +
  annotate("text", x = M_h_0 + 0.5, y = .300, label = paste("M_h_0 =", round(M_h_0, 2)), hjust = 0, size = 6, color = gg_color_hue(2)[2])
