...
dplyr::bind_rows(PPADDY14.gcl$attributes, 
  ...
  spread(`Otolith Mark Present`, n, fill = 0)
```
**Results:** There are **44** NAs from 2014.

Remove any NAs from 2014 and hatchery-origin fish + NA from 2016 - NAs must be from second reads. Hatchery-origin fish from 2014 are retained for looking at 2014/2016 parentage.
...
failure_rate
```
**Results:** There's a **9%** genotype failure rate in PPADDY14 and **2%** in PPADDY16, with an overall rate of **6%*8. There are some specific plate effects, but they are very scattered, as are any locus-specific failures. 
...
```
**Results:** Removed **1186** fish IDs from PPADDY14n, **116** from PPADDY14h, and **207** from PPADDY16.
...
```
**Results:** There were **four** duplicates in PPADDY14n and **five** in PPADDY16. There were **zero** duplicates in PPADDY14h.
...
```
**Results:** Final dataset contains **6,424** total fish: **9,620** from 2014 and **6,804** from 2016 (that's a lot!).
