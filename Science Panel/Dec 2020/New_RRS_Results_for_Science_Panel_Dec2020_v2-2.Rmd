...
# colorblind palette
cbPalette <- c("#CC79A7", "#0072b2", "#d55e00", "#F0E442")
...
stock_paired_16_18_filt_parents %>%
 ...
 geom_vline(xintercept=stock_fem_natur_16_18, color=cbPalette[1], linetype = "dashed", size = 2) +
 geom_vline(xintercept=stock_fem_hatch_16_18, size=2) +
 geom_vline(xintercept=stock_fem_hatch_16_18, color=cbPalette[2], linetype = "dashed", size = 2) +
 annotate("text", x = stock_fem_natur_16_18 + 0.5, y = .250, label = paste("fem_natur_RS =", round(stock_fem_natur_16_18, 2)), hjust = 0, size = 6, color = cbPalette[1]) +
 annotate("text", x = stock_fem_hatch_16_18 + 0.5, y = .300, label = paste("fem_hatch_RS =", round(stock_fem_hatch_16_18, 2)), hjust = 0, size = 6, color = cbPalette[2]) +
...
stock_paired_16_18_filt_parents %>%
 ...
 geom_vline(xintercept=stock_male_natur_16_18, color=cbPalette[1], linetype = "dashed", size = 2) +
 geom_vline(xintercept=stock_male_hatch_16_18, size=2) +
 geom_vline(xintercept=stock_male_hatch_16_18, color=cbPalette[2], linetype = "dashed", size = 2) +
 annotate("text", x = stock_male_natur_16_18 + 0.5, y = .250, label = paste("male_natur_RS =", round(stock_male_natur_16_18, 2)), hjust = 0, size = 6, color = cbPalette[1]) +
 annotate("text", x = stock_male_hatch_16_18 + 0.5, y = .300, label = paste("male_hatch_RS =", round(stock_male_hatch_16_18, 2)), hjust = 0, size = 6, color = cbPalette[2]) +
  theme(legend.position = c(0.8, 0.75), legend.background = element_rect(linetype = 1, size = 0.5, colour = 1)) +
  scale_fill_manual(values = cbPalette)
```
...
gil_paired_14_16_filt_parents %>% 
  ...
  geom_vline(xintercept=gil_fem_natur_14_16, color=cbPalette[1], linetype = "dashed", size=2) +
  geom_vline(xintercept=gil_fem_hatch_14_16, size=2) +
  geom_vline(xintercept=gil_fem_hatch_14_16, color=cbPalette[2], linetype = "dashed", size=2) +
  annotate("text", x = gil_fem_natur_14_16 + 0.5, y = .250, label = paste("fem_natur_RS =", round(gil_fem_natur_14_16, 2)), hjust = 0, size = 6, color = cbPalette[1]) +
  annotate("text", x = gil_fem_hatch_14_16 + 0.5, y = .300, label = paste("fem_hatch_RS =", round(gil_fem_hatch_14_16, 2)), hjust = 0, size = 6, color = cbPalette[2]) +
  theme_bw() +
  scale_fill_manual(values = cbPalette) +
  theme(legend.position = c(0.8, 0.75), legend.background = element_rect(linetype = 1, size = 0.5, colour = 1))
...
gil_paired_14_16_filt_parents %>% 
  ...
  geom_vline(xintercept=gil_male_natur_14_16, color=cbPalette[1], linetype = "dashed", size=2) +
  geom_vline(xintercept=gil_male_hatch_14_16, size=2) +
  geom_vline(xintercept=gil_male_hatch_14_16, color=cbPalette[2], linetype = "dashed", size=2) +
  annotate("text", x = gil_male_natur_14_16 + 0.5, y = .250, label = paste("male_natur_RS =", round(gil_male_natur_14_16, 2)), hjust = 0, size = 6, color = cbPalette[1]) +
  annotate("text", x = gil_male_hatch_14_16 + 0.5, y = .300, label = paste("male_hatch_RS =", round(gil_male_hatch_14_16, 2)), hjust = 0, size = 6, color = cbPalette[2]) +
  theme_bw() +
  scale_fill_manual(values = cbPalette) +
  theme(legend.position = c(0.8, 0.75), legend.background = element_rect(linetype = 1, size = 0.5, colour = 1))
...
gil_paired_16_18_filt_parents %>% 
  ...
  geom_vline(xintercept=gil_fem_natur_16_18, color=cbPalette[1], linetype = "dashed", size=2) +
  geom_vline(xintercept=gil_fem_hatch_16_18, size=2) +
  geom_vline(xintercept=gil_fem_hatch_16_18, color=cbPalette[2], linetype = "dashed", size=2) +
  annotate("text", x = gil_fem_natur_16_18 + 0.5, y = .250, label = paste("fem_natur_RS =", round(gil_fem_natur_16_18, 2)), hjust = 0, size = 6, color = cbPalette[1]) +
  annotate("text", x = gil_fem_hatch_16_18 + 0.5, y = .300, label = paste("fem_hatch_RS =", round(gil_fem_hatch_16_18, 2)), hjust = 0, size = 6, color = cbPalette[2]) +
  theme_bw() +
  scale_fill_manual(values = cbPalette) +
  theme(legend.position = c(0.8, 0.75), legend.background = element_rect(linetype = 1, size = 0.5, colour = 1))
...
gil_paired_16_18_filt_parents %>% 
  ...
  geom_vline(xintercept=gil_male_natur_16_18, color=cbPalette[1], linetype = "dashed", size=2) +
  geom_vline(xintercept=gil_male_hatch_16_18, size=2) +
  geom_vline(xintercept=gil_male_hatch_16_18, color=cbPalette[2], linetype = "dashed", size=2) +
  annotate("text", x = gil_male_natur_16_18 + 0.5, y = .250, label = paste("male_natur_RS =", round(gil_male_natur_16_18, 2)), hjust = 0, size = 6, color = cbPalette[1]) +
  annotate("text", x = gil_male_hatch_16_18 + 0.5, y = .300, label = paste("male_hatch_RS =", round(gil_male_hatch_16_18, 2)), hjust = 0, size = 6, color = cbPalette[2]) +
  theme_bw() +
  scale_fill_manual(values = cbPalette) +
  theme(legend.position = c(0.8, 0.75), legend.background = element_rect(linetype = 1, size = 0.5, colour = 1))
```
...
gil_parentage_paired_16_18_cross %>% 
  ...
  ylab("Proportion of Families per Cross Type") +
  theme_bw() +
  scale_fill_manual(values = c("#FFFFFF", "#F0E442")) +
  theme(text = element_text(size = 15), legend.position = c(0.8, 0.75), legend.background = element_rect(linetype = 1, size = 0.5, colour = 1))
```
