---
title: "Hogan Results for Science Panel"
output:
  html_notebook:
    theme: united
    toc: yes
...
```{r proportion_odd_data, echo=FALSE, warning=FALSE, message=FALSE}
...
O.odd <- c("H", "N")
Spawners.odd <- c(443, 322) #  number of hatchery- and natural-origin parents
