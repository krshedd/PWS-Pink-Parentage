...
One row per offspring that was assigned at least 1 parent.
...
*Note:* Correlation between parent-offspring sample location and narrow-sense heritability of sample location *not yet available*. GIS-based stream distance mapping is *in progress* by Chase Jalbert.
