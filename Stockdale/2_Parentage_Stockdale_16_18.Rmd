---
title: "Stockdale 2016/2018 Parentage Analysis with 298 Markers"
output:
  html_notebook:
    theme: united
    toc: yes
...
## *FRANz* parameters
*FRANz* was run atWed Oct 21 18:00:14 2020. We used the following parameters:
...
--Nmmax and --Nfmax are the maximum numbers of candidate mothers and fathers. To obtain our values, we used an estimated escapement of 26,000 and divided by 2 (*note: aerial survey was ??? and stream walk was 26,206*). This escapement number came from the stream walk AUC number, as I did not have an aerial survey AUC. This estimate is listed under 'pop est walk' in the Excel file found here: "V:\Documents\5_Coastwide\Multispecies\AHRP\Field data\Sample Summary Extract and Genotype.xlsx"   
