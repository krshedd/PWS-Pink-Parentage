...
write_csv(glm_model_summary, "../Stockdale/stock_glm_summary.csv")
```
...
write_csv(female_glm_model_summary, "../Stockdale/stock_glm_female_summary.csv")
```
...
write_csv(male_glm_model_summary, "../Stockdale/stock_glm_male_summary.csv")
```
