...
FRANz.exe --Nmmax 4150 --Nfmax 4150 --femrepro 1:2 --malerepro 1:2 --typingerror 0.005 --updatefreqs --poutformat 2 --fullsibtest "V:\Analysis\5_Coastwide\Multispecies\Alaska Hatchery Research Program\PWS Pink\Franz\stock_postQA_2013_2015_STOCK.dat"
...
All output files can be found here: "V:\Analysis\5_Coastwide\Multispecies\Alaska Hatchery Research Program\PWS Pink\Franz\Stockdale\Odd_Run 1"  
...
Calculate 95% CIs for Hogan 13-15 males. RRS = 0.34 (0.05-1.10)
...
FRANz.exe --Nmmax 4150 --Nfmax 4150 --femrepro 1:2 --malerepro 1:2 --typingerror 0.005 --updatefreqs --poutformat 2 --fullsibtest "V:\Analysis\5_Coastwide\Multispecies\Alaska Hatchery Research Program\PWS Pink\Franz\stock_postQA_2014_2016_STOCK.dat"
...
All output files can be found here: "V:\Analysis\5_Coastwide\Multispecies\Alaska Hatchery Research Program\PWS Pink\Franz\Stockdale\Even_Run 1"  
...
parentage_14_16 <- read_csv("v:/Analysis/5_Coastwide/Multispecies/Alaska Hatchery Research Program/PWS Pink/Franz/Stockdale/Even_Run 1/parentage.csv")
...
**Note** that *FRANz* assigned 1054 offspring to 405 parents. 864 of these offsrping have natural-origin parents and 373 offspring have hatchery-origin parents. The hatchery origin fish are from AFK12B, CCH12, and WNH12PINKB.
...
Offspring.even <- c(373, 864)  # number of offspring assigned to hatchery- and natural-origin parents
...
Calculate 95% CIs for Stockdale 14-16 females. RRS = 0.42 (0.36-0.50)
...
rrs_ci_kalinowski(n_h_off = 196, n_w_off = 447, n_h_par = 230, n_w_par = 221, alpha = 0.05)
```
...
*Need to filter out all lenghts below 300mm first, as they are clearly outliers*
...
write.csv(parents_paired_14_16, "stock_parents_paired_14_16.csv")
```
...
write.csv(paired_14_16_filter, "stock_paired_14_16_filter.csv")
...
There is a significant relationship between parental sample date and length (p = 0.03). 
