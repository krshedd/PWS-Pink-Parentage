...
ggplot(finsight_stockdale_filtered, aes(x = Longitude, y = Latitude)) +
  geom_point() +
  geom_vline(aes(xintercept = -147.183)) +
  geom_hline(aes(yintercept = 60.303))
...
riverdist_parentage_stock <- paired_14_16_filter_parents %>% 
...
write_csv(riverdist_parentage_stock, "riverdist_parentage_stock.csv")
```

Some quick exploratory plotting
```{r}
# riverdist_parentage_stock %>% 
#   count(Segment)
# 
# riverdist_parentage_stock %>% 
#   ggplot(aes(x = Longitude, y = Latitude, colour = Segment)) +
#   coord_equal() +
#   geom_jitter() +
#   theme_bw()
# 
# riverdist_parentage_stock %>% 
#   ggplot(aes(x = Longitude, y = Latitude, colour = origin, size = n, alpha = 0.05)) +
#   coord_equal() +
#   geom_jitter() +
#   theme_bw() +
#   transition_time(`Sample Date`) +
#   shadow_mark() +
#   enter_appear() +
