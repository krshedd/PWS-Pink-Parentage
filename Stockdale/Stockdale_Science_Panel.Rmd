...
Of the 3,093 offspring collected in 2015, 72 were assigned to parents, for an overall offspring assignment rate of **2.3%**. This assignment rate is in line with expectations based on parental sampling depth. All assignments were to one parent (*single parent-offspring duos*) - there were no two-parent assignments (*parent pair-offspring trios*).
...
Note that the confidence intervals for males are large due to the small numbers of offspring assigned to hatchery-origin males. 
...
2. 72 offspring were assigned to 54 parents (3 of which were hatchery-origin), for an assignment rate of **2.3%**. This assignment rate is similar to what was observed for Hogan 2013/2015 (huge parent escapement in 2013 relative to sampling rate) and in line with expectations based on parent sampling depth. 
...
Of the 5,199 offspring collected in 2016, 1,054 were assigned to parents, for an overall offspring assignment rate of **20.3%**. This is in line with expectations based on parent sampling depth
...
The above plot shows RS by parent sample date, separately for females (top) and males (bottom). We see that RS does vary due to sample date, with the lowest RS values in the middle of the season (perhaps due to increased fishing pressure or density dependence on the spawning grounds). However, both early and late in the season natural-origin fish have higher RS than hatchery-origin fish in both sexes. This suggests that our measured difference in RRS is not due solely to differences in run timing (sample date) between hatchery- and natural-origin fish. 
...
4. RRS was significant for both males (0.28 [CI's 0.24-0.34]) and females (0.42 [CI's 0.35-0.50]). 
5. RS significantly varied with parent sample date (early fish do best, middle fish worst, late returning okay). Across most of the season (particularly the tails), regardless of sample date, natural-origin fish had higher RS than hatchery-origin fish. 
6. RS significantly varied with parent size (large males had more offspring than smaller males). However, regardless of size, natural-origin males had higher RS. 
7. 183 offspring assigned to two parents (trios).
8. RRS was significant for HH vs. NN crosses (0.61 [CI's 0.35-0.99]). There was no significant difference between RRS of either hybrid type (HN or NH) versus NN. 
