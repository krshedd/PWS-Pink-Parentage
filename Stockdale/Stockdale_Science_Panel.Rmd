...
Calculate 95% CIs for Stockdale 14-16 females. RRS = 0.42 (0.35-0.50). The top table represents parent sample sizes and the bottom table represents offspring sample sizes. 
...
Calculate 95% CIs for Hogan 14-16 males. RRS = 0.28 (0.24-0.34). The top table represents parent sample sizes and the bottom table represents offspring sample sizes. 
...
Is this statistically significant? The top table represents parent sample size and the bottom table represents offspring sample size. Confidence intervals are shown for the following comparisons: HH x NN, HN x NN, NH x NN. The only significant difference in RRS is between HH and NN matings. NN matings produce significantly more offspring than HH matings. 

```{r RRS_confidence_intervals_14_16_setup, echo=FALSE, warning=FALSE, message=FALSE}
