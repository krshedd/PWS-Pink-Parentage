...
The above plot show RS by parent sample date, separately for females (top) and males (bottom). We see that there were no hatchery-origin fish sampled in the first event. RS appears to be more productive early in the season than later on, and this pattern is more pronounced in males than in females. Note that points are jittered by sample date (x-axis) to avoid overplotting. 
...
The above plot show RS by parent body length, separately for females (top) and males (bottom). It is difficult to draw conclusions about this relationship for hatchery-origin parents since there were so few assignments. Sample sizes are small, which makes it difficult to draw robust conclusions.
