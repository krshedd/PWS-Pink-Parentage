...
oceanak <-
  readr::read_csv(file = "../../OceanAK/AHRP Salmon Biological Data 20220426_092121.csv") # read in OceanAK data; recommend new data pull prior to running
```
...
# STOPPED HERE 4/26/22 DUE TO DUPLICATE ISSUE!!!
...
Huh, it looks like we have 48 samples that exist twice in the database!
...
Of the 5,425 individuals removed, almost half were from PSTOCK16!
...
Hrrm, looks like there are 28 individuals from PPADDY18 that are repeated? WTF? Why did those get read in twice? All are hearts...
