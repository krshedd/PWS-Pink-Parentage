...
Lol, the Paddy:intertidal variable ruins everything
```{r}
modelsummary::modelplot(models = glm_male_1)
```
...
```{r}
p<-modelsummary::modelplot(mod,coef_rename=renamed,coef_omit='Interc')
...
```{r}
modelsummary::modelplot(models = glm_female_1)
```
